          ...
          screenOptions={({ route }) => {
            ...
            return {
              ...
              tabBarIcon: ({ focused, size }) => {
                ...
                // Optional: Add opacity for inactive state if desired, 
                // but user asked for them to be colored. 
                // We can keep full color or slightly fade. 
                // Let's keep full color as requested "fiquem mesmo sem clicar".
